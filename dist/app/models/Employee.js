...
function insertEmployee(fk_department, name, surname, cpf, email, salary) {
...
function verifyEmployee(cpf, fk_department) {
    return __awaiter(this, void 0, void 0, function () {
        var conn, query, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, conn.query(query, [cpf, fk_department])];
                case 2:
                    result = _a.sent();
                    conn.release();
...
function insertPermissionEmployee(fk_employee, fk_permission) {
    return __awaiter(this, void 0, void 0, function () {
        var conn, query, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, conn.query(query, [fk_employee, fk_permission])];
                case 2:
                    result = _a.sent();
                    conn.release();
                    return [2 /*return*/, result.rows[0]];
...
exports.insertPermissionEmployee = insertPermissionEmployee;
...
function getPermissionEmployee(id) {
    return __awaiter(this, void 0, void 0, function () {
        var conn, query, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.getPermissionEmployee = getPermissionEmployee;
function deletePermissionEmployee(fk_employee, fk_permission) {
    return __awaiter(this, void 0, void 0, function () {
        var conn, query, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.deletePermissionEmployee = deletePermissionEmployee;
function verifyUpdateEmployee(id) {
    return __awaiter(this, void 0, void 0, function () {
        var conn, query, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.verifyUpdateEmployee = verifyUpdateEmployee;
function updateEmployee(name, surname, cpf, email, salary, id) {
    return __awaiter(this, void 0, void 0, function () {
        var conn, queryPart1, sets, values, k, queryPart2, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dbConnection_1.default.connect()];
                case 1:
                    ...
                    queryPart2 = "\n        WHERE fg_active = true AND id_employee = $1;";
                    return [4 /*yield*/, conn.query(queryPart1 + sets.join(', ') + queryPart2, values)];
                case 2:
                    result = _a.sent();
                    conn.release();
                    return [2 /*return*/, result.rows[0]];
