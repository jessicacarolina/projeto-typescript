...
function verifyDepartment(name) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, conn.query(query, [name, description])];
                case 2:
                    result = _a.sent();
                    conn.release();
...
function verifyUpdateDepartment(id) {
    return __awaiter(this, void 0, void 0, function () {
        var conn, query, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.verifyUpdateDepartment = verifyUpdateDepartment;
function updateDepartment(nm_department, ds_department, id) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    values = [id];
                    k = 2;
                    if (nm_department !== undefined) {
                        sets.push("nm_department = $" + k++);
                        values.push(nm_department);
                    }
                    if (ds_department !== undefined) {
                        sets.push("ds_department = $" + k++);
                        values.push(ds_department);
                    }
                    queryPart2 = "\n    WHERE fg_active = true AND id_department = $1;";
